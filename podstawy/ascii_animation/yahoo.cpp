// Zrodlo: http://www.a1k0n.net/2011/06/26/obfuscated-c-yahoo-logo.html
//
// Kompilacja: g++ yahoo.cpp -lm
//
#include<math.h>
#include<stdio.h>
#include<unistd.h>
int c,p,i,j,n,F=40,k,m;float a,x,y,S=0,V=0;main(){for(;F--;usleep(50000),F?puts(

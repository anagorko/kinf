...
int main(int argc, char** argv)
{
    ...
    ALLEGRO_EVENT event;
	 ...
	 al_flip_display();
        al_rest(0.5);//pauza
	al_clear_to_color(al_map_rgb(140,140,140)); //tło
        al_draw_line( 15, 20, 90, 100, al_map_rgba( 0, 255, 0, 128), 4);
        al_draw_triangle(105, 20, 155, 30, 130, 85, al_map_rgb(255, 0, 0), 8);
        al_draw_filled_triangle(195, 20, 255, 81, 180, 85, al_map_rgb(0,0,255));
        al_draw_rectangle(255,15,305, 65,al_map_rgba(255,255,0,128),2);
        al_draw_filled_rectangle(285, 25,355, 85,al_map_rgba(0,0,0,100));
        al_draw_rounded_rectangle( 55,105,105,155,17,17,al_map_rgb(0,255,255),5);
        al_draw_filled_rounded_rectangle(115, 95,155,159, 17, 25,al_map_rgb(128,0,255));
        al_draw_circle(205,125, 35, al_map_rgb( 0,128, 0), 20);
        al_draw_filled_circle(255,125, 39, al_map_rgba(200,28, 0,60));
	 al_flip_display();
        al_rest(0.5);//pauza
	al_clear_to_color(al_map_rgb(150,150,150)); //tło
        al_draw_line( 10, 15, 80, 90, al_map_rgba( 0, 255, 0, 128), 4);

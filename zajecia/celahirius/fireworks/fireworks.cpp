...
void rysuj_plansze()
{
    ...
    for (int i = 0; i < n; i++) {
        ...
        al_draw_filled_circle(o[i].x, o[i].y, 5,  al_map_rgb(0,255,0) /*al_map_rgb((rand() % 256)/6.0, o[i].life * (150 / default_life), (rand() % 256)/6.0)*/);
    }
}
